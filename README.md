...
Originalmente projetado como uma aplicação simples, o sistema foi evoluído para uma API robusta utilizando **Spring Boot**, com persistência real em banco de dados **PostgreSQL** via JDBC, seguindo padrões profissionais de desenvolvimento para portfólios técnicos.
